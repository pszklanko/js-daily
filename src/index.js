...
const yearsTotal = inventors.reduce((prev, current) => {
    return prev + (current.passed - current.year)}, 0);
...
const oldest = inventors.sort(compare)
...
const srtd1 = people.sort((lastOne, nextOne) => {
